...
void printErrorCode()
{
  ...
  display.drawString(64 ,10 , "FAIL");                    //  holds the last recieved code
  display.drawString(64 ,40 , String(myMHZ19.errorCode));                    //  holds the last recieved code
}
...
//  if (myMHZ19.errorCode == RESULT_FILTER) {
//    display.drawString(64 ,10 , "sensors: mhz: warming up...");
//    display.display();
//  } else if (myMHZ19.errorCode != RESULT_OK) {
//    display.drawString(64 ,10 ,"sensors: mhz: failed to read CO2 on warmup.");
//    display.display();
//  } else if (myMHZ19.getCO2(false) == 0) {
//    // TODO: remove when zero co2 is filtered
//    // https://github.com/WifWaf/MH-Z19/issues/6
//    display.drawString(64 ,10 ,"sensors: mhz: received zero, continuing warmup...");
//    display.display();
//  } else {
    // warmed up
